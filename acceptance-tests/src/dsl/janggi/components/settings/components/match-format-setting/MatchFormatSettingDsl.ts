...
import type {MatchFormatSettingPlaywright} from "@src/dsl/janggi/components/settings/components/match-format-setting/playwright/MatchFormatSettingPlaywright";

/** The picker for which game is being played, reached as `janggi.settings.matchFormat`. */
export class MatchFormatSettingDsl {
  constructor(private readonly matchFormat: MatchFormatSettingPlaywright) {}
