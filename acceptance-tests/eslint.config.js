  ...
  ...baseConfig({tsconfigRootDir: import.meta.dirname, allowedPackages: ["@janggi/shared"]}),
  {
    ...
    rules: {
      ...
      "no-restricted-syntax": [
        ...
        {
          selector:
            'CallExpression[callee.name="then"] CallExpression[callee.property.name=/^(tap|hover|resizeWindowTo|navigateToPage|setTo|set[A-Z].*To|startNewGame|pass|callBikjang|offerDraw|acceptDraw|declineDraw|undo|redo|toggleMute|toggleExplanation|waitForTheBot|waitForTheBotToLoad|retryTheBot|holdBackTheBotsEngine|cutOffTheBotsEngine|restoreTheBotsEngine|reload|reloadOffline|resetRecord|openReferences|visitReferences|visitGuide|offerInstallation|chooseInstall|choose|openPiece|followToolsWithKeyboard|loadSave|importStyle|makeStyle|deleteStyle|setProgress|makeAvailable|refresh|leaveUntilLater|openTheSettings|selectTab|show|continueTheWelcome|skipTheWelcome|startTheTour|pressEscape|nextTourStep|previousTourStep|skipTheTour|finishTheTour|replayTheTour)$/]',
          message:
