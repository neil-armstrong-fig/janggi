    ...
    <main data-testid="references" className="mx-auto max-w-5xl px-5 py-10 text-wood sm:px-10 sm:py-16">
      <header className="max-w-2xl">
        ...
        <p className="mt-5 text-lg leading-relaxed text-wood/80">
          A game with a long history, made possible here by a generous community. Thank you to the players, writers and
          open source contributors whose work helped us build it.
        </p>
