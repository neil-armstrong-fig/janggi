 ...
 *
 * In the footer of the settings sheet's Game tab, under the format and the two setups, rather than in
 * the row of controls under the board. It deals from those three, so it belongs beside them — pinned
 * where a thumb reaches it however far they have been scrolled — and a control that throws a game away
 * is better a sheet away from a thumb that was reaching for Undo. Once a game has ended the
