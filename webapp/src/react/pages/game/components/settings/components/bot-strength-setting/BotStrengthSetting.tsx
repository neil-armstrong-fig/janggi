...
import {BOT_STRENGTH_OPTIONS} from "@src/react/pages/game/components/settings/utils/OpponentOptions";
...
import {lockBehindBot} from "@src/react/pages/game/components/settings/locks/LockBehindBot";
