 ...
 *
 * Not unit tested itself: it is a composition of `gameStatusOf`, `botDutyFor` and `botAwaitsGoAhead`, each
 * tested beside it, and the parts that read it are covered by the acceptance specs.
 */
