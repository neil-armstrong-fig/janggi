 ...
 *
 * `movesPlayed` is what locks the setups: a back rank is arranged strictly before play, so once a
 * move has been made neither picker may be used. `GamePage` disables them on it, and `restarted`
