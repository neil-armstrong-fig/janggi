...
/**
 * The other half of `vitest.config.ts`: it runs everything except the property tests, and this runs
 * only them. Between the two, every test file is covered exactly once.
 *
